...
# Option 1: Access a built-in data frame called Housing from the Ecdat package

# Option 2: Create your own data frame
...
# In standard R syntax, you can extract a column of a data frame as a vector using $
 # "Show me the contents of the component called one in the object called mydata"

# Then you can treat it like a regular vector
# Goal: What is the average value in the column called one?


# Goal: What is the maximum price in the housing data??


# Option 3: Import data from an external source
